...
const movieTemplete = (movieDetail) => {
    const time = parseInt(movieDetail.Runtime.replace(/min/g, ''));
    ...
    const data = new Date(movieDetail.Released);
    return `
        <article class="media">
        ...
        <article data-value=${data}  class="notification is-primary">
            <p class="title">${movieDetail.Released}</p>
            <p class="subtitle">Release Date</p>
        </article>

        <article data-value=${time} class="notification is-primary">
